...
def test_shop_form(chrome_browser):
    ...
    chrome_browser.find_element(By.ID, "first-name").send_keys("Sergey")
    chrome_browser.find_element(By.ID, "last-name").send_keys("Andreev")
    chrome_browser.find_element(By.ID, "postal-code").send_keys("152470")
